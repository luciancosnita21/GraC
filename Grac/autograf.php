...
private $tip;
  ...
  public function __construct($idUser,$path, $title, $date1, $date2,$date3,$detl,$tag,$tip){
...
$stmt = $pdo->prepare("insert into autograf (id,idUser,imagine,title,data_achizitionare,personalitate,domeniu,detalii_aditionale,tag,scop) values (:id,:idUser,:path,:title,:date1,:date2,:date3,:detl,:tag,:tip)");
